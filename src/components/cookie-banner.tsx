...
export function CookieBanner() {
  ...
  return (
    ...
    >
      <div className="relative card-elevated bg-white/85 backdrop-blur-xl border border-[#003d9b]/15 rounded-[24px] p-5 md:p-6 shadow-[0_8px_32px_rgba(0,61,155,0.18)]">
        <button
          onClick={dismiss}
          aria-label="Đóng"
        ...
        <div className="flex items-start gap-3 mb-4 pr-6">
          <div className="shrink-0 w-10 h-10 rounded-2xl bg-[#003d9b]/10 text-[#003d9b] flex items-center justify-center text-lg">
            🍪
          </div>
          <div>
            <h3
            ...
            <p className="text-sm text-[#434654] leading-relaxed">
              ...
              <Link
                href="/bao-mat"
                className="text-[#003d9b] underline underline-offset-2 font-medium"
              >
                Chính sách bảo mật
              </Link>
              .
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:justify-end">
          <Link
            href="/bao-mat"
            className="text-center px-4 py-2.5 rounded-[16px] text-sm font-semibold text-[#003d9b] hover:bg-[#003d9b]/5 transition-colors"
          >
            Tìm hiểu thêm
          </Link>
          <button
            onClick={accept}
            className="px-5 py-2.5 rounded-[16px] text-sm font-semibold bg-[#003d9b] text-white hover:bg-[#002d75] transition-colors"
          >
            Chấp nhận
          </button>
        </div>
